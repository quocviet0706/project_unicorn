...
const Purchase = ({ className, showPurchase }) => {
  ...
  const [visibleModalFolow_Steps, setVisibleModalFolow_Steps] = useState(false);
  const cancel = () => {
  ...
  return (
    <>
        ...
        <div className={cn(className, styles.checkout)}>
          ...
          <div className={styles.btns}>
            <button
              ...
              onClick={() => setVisibleModalFolow_Steps(true)}
            >
      ...
      <Modal
         visible={visibleModalFolow_Steps}
         onClose={() => setVisibleModalFolow_Steps(false)}
      >
        <Flow_Steps />
      </Modal>
    </>
